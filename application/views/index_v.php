...
<body id="page-top">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Apa Keluhan Anda Dengan Jasa Kami?</h5>
                ...
                <div class="modal-body" style="overflow-x: auto;">
                    <form class="form" id="form1" method="post" action="home/sendreport">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" readonly class="form-control" value="<?= $this->session->userdata('users')['nama_pelanggan'] ?>">
                        </div>
                        <div class="form-group">
                            <label for="alamat" class="col-form-label">Alamat Anda</label>
                            <textarea class="form-control" name="alamat" readonly><?= $this->session->userdata('users')['alamat_pelanggan'] ?></textarea>
                        </div>
                        <div class="form-group">
    ...
    <div id="classModal" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="classInfo" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <form action="home/inputKuesioner" method="post">
                <div class="modal-header">
    ...
    <script>
        ...
        if($('input[id=jawaban_satu]:checked').length >= 2){
            this.checked = false;
            alert('Hanya boleh memilih 1 !');
        }
        if($('input[id=jawaban_dua]:checked').length >= 2){
            this.checked = false;
            alert('Hanya boleh memilih 1 !');
        }
        if($('input[id=jawaban_tiga]:checked').length >= 2){
            this.checked = false;
            alert('Hanya boleh memilih 1 !');
        }
        if($('input[id=jawaban_empat]:checked').length >= 2){
            this.checked = false;
            alert('Hanya boleh memilih 1 !');
        }
        if($('input[id=jawaban_lima]:checked').length >= 2){
            this.checked = false;
            alert('Hanya boleh memilih 1 !');
        }
        });
