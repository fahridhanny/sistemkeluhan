    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto my-2 my-lg-0">
                ...
                <?php if (!empty($users)) { ?>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="" data-toggle="modal" data-target="#exampleModal">Keluhan</a></li>
                ...
                <?php } else { ?>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="login"><?= $users['nama_pelanggan'] ?></a></li>
                <?php } ?>
                <?php if (!empty($users)) { ?>
